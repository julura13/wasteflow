...
class CompanySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $companies = [
            [
                'name' => 'Southgate Retail Group',
                'email' => 'contact@southgateretail.example.com.au',
                'phone' => '+61 2 8885 3000',
                'address' => '1 Southgate Way, Bella Vista NSW 2153',
                'contact_person' => 'John Smith',
                'registration_number' => 'ACN 111 222 333',
                'branches' => [
                    [
                        'name' => 'NSW Operations',
                        'email' => 'nsw@southgateretail.example.com.au',
                        ...
                        'sites' => [
                            [
                                ...
                                'email' => 'cbd001@southgateretail.example.com.au',
                            ],
                            [
                                ...
                                'email' => 'bj002@southgateretail.example.com.au',
                            ],
                        ],
                    ],
                    [
                        'name' => 'VIC Operations',
                        'email' => 'vic@southgateretail.example.com.au',
                        ...
                        'sites' => [
                            [
                                ...
                                'email' => 'mc003@southgateretail.example.com.au',
                            ],
                        ],
                    ],
                ],
            ...
            [
                'name' => 'Pinewood Grocery Co',
                'email' => 'contact@pinewoodgrocery.example.com.au',
                'phone' => '+61 3 9829 3111',
                'address' => '800 Pinewood Road, Tooronga VIC 3146',
                'contact_person' => 'Robert Taylor',
                'registration_number' => 'ACN 444 555 666',
                'branches' => [
                    [
                        'name' => 'QLD Operations',
                        'email' => 'qld@pinewoodgrocery.example.com.au',
                        ...
                        'sites' => [
                            [
                                ...
                                'email' => 'bc001@pinewoodgrocery.example.com.au',
                            ],
                        ],
                    ],
                ],
