...
class RecoveryRatingTierSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $tiers = [
            ...
            ['name' => 'Gold', 'slug' => 'gold', 'min_percentage' => 75, 'color' => '#D4AF37', 'sort_order' => 5],
            ['name' => 'Silver', 'slug' => 'silver', 'min_percentage' => 60, 'color' => '#A8A9AD', 'sort_order' => 4],
            ['name' => 'Bronze', 'slug' => 'bronze', 'min_percentage' => 40, 'color' => '#CD7F32', 'sort_order' => 3],
            ['name' => 'Developing', 'slug' => 'developing', 'min_percentage' => 20, 'color' => '#2D9CDB', 'sort_order' => 2],
