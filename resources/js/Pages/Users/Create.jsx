...
export default function UsersCreate({ roles, companies }) {
            ...
            <div className="bg-white dark:bg-gray-800 shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
                        Create a user and assign roles to control what they can do (create/consolidate orders, capture documents, capture weights, finalize orders).
                    </p>
