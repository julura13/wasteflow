...
const COLUMN_TOOLTIPS = {
    material: 'Category labels match docs/Landfill space saved m3.xlsx column B.',
    weight: 'Recovered / diverted weight in kilograms (column C in the spreadsheet).',
    density:
        'Density factor in kg/m³ (column D). Landfill airspace avoided per row = Weight ÷ Density.',
    spaceSaved: 'Estimated landfill airspace avoided for this row in m³ (column E).',
};

export default function LandfillSpaceCalculator() {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        axios
            .post(route('reports.landfill-space-calculator.calculate'), { weights: payload })
            .then(({ data }) => {
    ...
    return (
        <DashboardLayout title="Landfill space calculator">
            <Head title="Landfill space calculator" />
            ...
            <div className="max-w-5xl mx-auto">
                <div className="mb-4">
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Same calculation as the Waste Management Report summary. Each row:{' '}
                        <span className="font-medium text-gray-800 dark:text-gray-200">
                            airspace avoided (m³) = weight (kg) ÷ density (kg/m³)
                        </span>
                        . Source:{' '}
                        <code className="text-xs bg-gray-100 dark:bg-gray-700 px-1 rounded">
                            docs/Landfill space saved m3.xlsx
                        </code>
                        .
                    </p>
                </div>
                                ...
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    <thead className="bg-gray-50 dark:bg-gray-700">
                                        <tr>
                                            ...
                                            >
                                                <div className="flex items-center justify-end gap-1">
                                                    <span>
                                                        Space saved (m<sup>3</sup>)
                                                    </span>
                                                    <TooltipButton
                                                        id="spaceSaved"
                                                        active={activeHeaderTooltip}
                                                        setActive={setActiveHeaderTooltip}
                                                        text={COLUMN_TOOLTIPS.spaceSaved}
                                                        alignRight
                                                    />
                                                </div>
                                            </th>
                                    ...
                                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tr className="bg-gray-50 dark:bg-gray-700 font-bold">
                                            ...
                                            >
                                                Total estimated landfill airspace avoided
                                            </td>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden mb-4">
                        ...
                        <div className="px-4 py-4 text-sm text-gray-700 dark:text-gray-300 space-y-2">
                            ...
                            <p className="text-gray-500 dark:text-gray-400 text-xs">
                                Row totals are rounded to two decimals before summing, matching report
                                behaviour.
                            </p>
                        </div>
                    </div>
